...
@Override
    public Department getByName(String name) throws DepartmentRepositoryException {
    ...
    try (Connection connection = getConnection()) {
        ...
        throw new DepartmentRepositoryException("Error while getting name of department",e);
    }
}
